...
2. Fork the [HMFAYSAL Notepad Theme repo](https://github.com/amnagrawal/amnagrawal-omega-theme/fork)
...
<div class="span7 text-center" markdown="0"><a href="https://github.com/amnagrawal/amnagrawal-omega-theme/archive/master.zip" class="btn btn-success btn-large"><i class="icon-download-alt"></i> Download the Theme</a></div>  
<br>
...
owner:
  ...
  # To register at HMFAYSAL SOCIAL, visit http://social.amnagrawal.tk
  twitter:
  facebook:
  github:
  linkedin:
...
Having a problem getting something to work or want to know why I setup something in a certain way? Ping me on Twitter [@amnagrawal](http://twitter.com/amnagrawal) or [file a GitHub Issue](https://github.com/amnagrawal/amnagrawal-omega-theme/issues/new).

---

## Requests?

If you have some specific requests for this theme, or if you need help custom coding some elements, message me on Twitter [@amnagrawal](http://twitter.com/amnagrawal) or email me at [amnagrawal@alum.mit.edu](mailto:amnagrawal@alum.mit.edu)
...
If you'd like to give me credit somewhere on your blog or tweet a shout out to [@amnagrawal](https://twitter.com/amnagrawal), that would be pretty sweet.

[^1]: Used to generate absolute urls in `sitemap.xml`, `feed.xml`, and for canonical urls in `head.html`. Don't include a trailing `/` in your base url ie: http://amnagrawal.github.io. When developing locally I suggest using `http://localhost:4000` or whatever server you're using to properly load the theme's stylesheet, scripts, and image assets. If you leave this variable blank all links will resolve correctly except those pointing home.